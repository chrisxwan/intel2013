...
public class RM9_1Forecast
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        RM9_1Forecast forecast = new RM9_1Forecast(3, 6, 1, q, r, t, "weightsrm9_1.txt", "maxminrm9_1.txt");
        forecast.run();
    }
    
    public RM9_1Forecast(int input, int hidden, int output, double q, double r, double t, String weight, String maxmin) throws IOException
    {
        int marker = 0;
