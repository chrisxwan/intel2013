...
public class RM9_1Hindcast
{
    ...
    {
        RM9_1Hindcast hindcast = new RM9_1Hindcast(3, 6, 1, "qtest10_temp.txt", "rtest_temp.txt", "ttest_temp.txt", "weightsRM9_1.txt", "maxminRM9_1.txt");
        hindcast.run();
    }
    
    public RM9_1Hindcast(int input, int hidden, int output, String i1, String i2, String i3, String weight, String maxmin) throws IOException
    {
        int marker = 0;
