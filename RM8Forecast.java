 ...
 * forecast the salinity at RM8 given input prompts.
 *
...
public class RM8Forecast
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        System.out.println("What is the tide in feet?");
        double t = in.nextDouble();
        RM8Forecast forecast = new RM8Forecast(3, 5, 1, q, r, t, "weightsrm8.txt", "maxminrm8.txt");
        forecast.run();
    }
    
    public RM8Forecast(int input, int hidden, int output, double q, double r, double t, String weight, String maxmin) throws IOException
    {
        int marker = 0;
    ...
    {
        System.out.println("Salinity Results for RM 8: ");
        for(int p = 0; p < inputs.length; p++)
        {
