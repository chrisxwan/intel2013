...
public class RM8Network {
    ...
    {
        RM8Network nn = new RM8Network(3, 5, 1, "qtrain10.txt", "rtrain.txt", "trealtrain.txt", "RM8train.txt");
        int maxRuns = 50000;
        double minErrorCondition = 0.001;
        nn.run(maxRuns, minErrorCondition);
    }

    public RM8Network(int input, int hidden, int output, String i1, String i2, String i3, String o1) throws IOException
    {
        PrintWriter outFile = new PrintWriter(new FileWriter("maxminRM8.txt"));
    ...
    public void printAllWeights() throws IOException {
        PrintWriter outFile = new PrintWriter(new FileWriter("weightsRM8.txt"));        
